...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
	...
	Semantic HTML is HTML that is legible to both programmers and computers.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

	Objects which display inline cannot change margins or padding.
...
5. Explain why git is valuable to a team of developers.
	...
	Git is valuable to a team of developers so they can keep track of their collaboration, including changes and previous versions
